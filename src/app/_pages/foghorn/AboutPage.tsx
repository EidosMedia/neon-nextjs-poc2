  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#ffffff' }}>
      ...
      <div className="w-full max-w-[740px] mx-auto px-4 py-10">
        ...
        <div style={{ fontFamily: 'var(--font-body)', fontSize: 18, lineHeight: 1.75, color: '#333333' }} className="flex flex-col gap-5">
          <p>
          ...
          <p>
            ...
            <Link href="https://github.com/EidosMedia/neon-nextjs-poc2" style={{ color: '#052962', textDecoration: 'underline' }}>
